...
public class VentanaMostrarDeuda extends javax.swing.JFrame {

    Venta m = new Venta();
    public VentanaMostrarDeuda(Venta x) throws FileNotFoundException {
        initComponents();
        m=x;
    ...
    private void initComponents() {
        ...
        getContentPane().add(NC1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 320, 670, 30));

        CC1.setFont(new java.awt.Font("Rockwell Condensed", 0, 36)); // NOI18N
        CC1.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(CC1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, 750, 30));
        ...
        getContentPane().add(Fecha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 380, 900, 30));
        ...
        getContentPane().add(NV1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 200, 760, 30));
        ...
        getContentPane().add(CI1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 440, 810, 30));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 100, -1, -1));
        getContentPane().add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 150, 320, 20));
