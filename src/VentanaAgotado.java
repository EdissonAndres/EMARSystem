...
public class VentanaAgotado extends javax.swing.JFrame {
long ap = 0;
int k=0;
int sig=0;
String buscar;
    public VentanaAgotado() throws IOException {
        initComponents();
    ...
    public void mostrar () throws IOException{
        ...
        for (int i=0; i<23; i++){
            ...
            if (archivo.getFilePointer() < archivo.length()){
                ...
                if ((b.getCantidad()!=-1) && (b.getCantidad()<6)){
    ...
    private void initComponents() {
        ...
        getContentPane().add(combo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 530, 200, 30));
        ...
        getContentPane().add(Cat, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, -1, 40));
        ...
        getContentPane().add(Inicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 530, 110, 40));
        ...
        Titulo1.setFont(new java.awt.Font("Rockwell Condensed", 0, 48)); // NOI18N
        Titulo1.setForeground(new java.awt.Color(255, 255, 255));
        Titulo1.setText("Listado Completo de Productos Agotados");
        getContentPane().add(Titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 60, 670, 50));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, 630, 20));
    ...
    public void mostrar1 (String buscar) throws IOException{
        ...
        for (int i=0; i<23; i++){
            ...
            if (archivo.getFilePointer() < archivo.length()){
                b.recuperarProducto(archivo);
                if ((b.getCantidad()!=-1) && (b.getCategoria().equals(buscar)) && (b.getCantidad()<6)){
                    String z = Long.toString(b.getCantidad());
                    String s = Long.toString(b.getValorUnitario());
                    matris[i][0] = b.getDescripcion();
                    matris[i][1] = b.getMarca();
