...
long ap = 0;
int k=0;
    public VentanaListarVentas() throws IOException {
        initComponents();  
    ...
    private void initComponents() {
        ...
        getContentPane().add(InicioAM, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 530, 100, 40));
        ...
        getContentPane().add(SiguienteAM, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 530, 140, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 1040, 360));

        Titulo.setFont(new java.awt.Font("Rockwell Condensed", 0, 48)); // NOI18N
        Titulo.setForeground(new java.awt.Color(255, 255, 255));
        Titulo.setText("Listado Completo de las Ventas");
        getContentPane().add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 80, 620, 60));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 140, 490, 20));
